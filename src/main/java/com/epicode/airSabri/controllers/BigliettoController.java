...
public class BigliettoController {
	...
	public ResponseEntity<String> createBiglietto(@RequestBody BigliettoDTO biglietto) {
		...
		b.setNumeroPosto(biglietto.getNumeroPosto());
	...
	@GetMapping("/{username}")
	@PermitAll
	public ResponseEntity<List<Biglietto>> getAllBiglietti(@PathVariable String username) {
	    return ResponseEntity.ok(bigliettoService.findTicket(username));
	}
